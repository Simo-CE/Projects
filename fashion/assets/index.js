import { S, P as $ } from "./vendor.min.js";
const x = function () {
    ...
    new MutationObserver((i) => {
        for (const t of i) if (t.type === "childList") for (const c of t.addedNodes) c.tagName === "LINK" && c.rel === "modulepreload" && l(c);
    ...
    function o(i) {
        ...
        return (
            ...
            i.crossorigin === "use-credentials" ? (t.credentials = "include") : i.crossorigin === "anonymous" ? (t.credentials = "omit") : (t.credentials = "same-origin"),
            t
        );
    }
    function l(i) {
        ...
        on: {
            transitionStart(e) {
                ...
                a.css("background-color", y),
                    ...
                    m.transitionEnd(() => {
                        g.transition(1300).transform("translate3d(0, 0, 0) scale(1.2)"), m.transition(1300).transform(`translate3d(${60 * p}%, 0, 0)  scale(1.2)`);
                    });
            },
            transitionEnd(e) {
                ...
                a.find(".fashion-slider-scale").transform("scale(1)"),
                    ...
                    s === 0 ? n.find(".fashion-slider-button-prev").addClass("fashion-slider-button-disabled") : n.find(".fashion-slider-button-prev").removeClass("fashion-slider-button-disabled"),
                    s === r.length - 1 ? n.find(".fashion-slider-button-next").addClass("fashion-slider-button-disabled") : n.find(".fashion-slider-button-next").removeClass("fashion-slider-button-disabled");
            },
            init(e) {
                const { slides: r, activeIndex: s, $el: n } = e;
                t(n);
