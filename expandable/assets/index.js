import { S as e } from "./vendor.min.js";
!(function () {
    const e = document.createElement("link").relList;
    if (!(e && e.supports && e.supports("modulepreload"))) {
        for (const e of document.querySelectorAll('link[rel="modulepreload"]')) i(e);
        new MutationObserver((e) => {
            for (const n of e) if ("childList" === n.type) for (const e of n.addedNodes) "LINK" === e.tagName && "modulepreload" === e.rel && i(e);
    ...
    const n = i.querySelector(".swiper"),
        o = (e) => {
            ...
            const { offsetHeight: c, offsetWidth: l } = n,
                r = { "--expanding-collection-scale-x": (o / l) * 0.95, "--expanding-collection-scale-y": (t / c) * 0.95 };
