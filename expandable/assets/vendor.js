...
const N = {
		...
		update: {
			...
			updateSlides: function() {
				...
				let S = i.spaceBetween,
					...
					x = 0;
				if (void 0 === r) return;
				"string" == typeof S && S.indexOf("%") >= 0 && (S = parseFloat(S.replace("%", "")) / 100 * r), e.virtualSize = -S, a ? c.css({
					marginLeft: "",
					marginBottom: "",
					marginTop: ""
				}) : c.css({
				...
				for (let v = 0; v < p; v += 1) {
					...
					if (E && e.grid.updateSlide(v, n, p, t), "none" !== n.css("display")) {
						if ("auto" === i.slidesPerView) {
							...
							if (a && (n[0].style.transform = "none"), o && (n[0].style.webkitTransform = "none"), i.roundLengths) y = e.isHorizontal() ? n.outerWidth(!0) : n.outerHeight(!0);
							else {
								const e = s(r, "width"),
									t = s(r, "padding-left"),
									i = s(r, "padding-right"),
							...
							a && (n[0].style.transform = a), o && (n[0].style.webkitTransform = o), i.roundLengths && (y = Math.floor(y))
						} else y = (r - (i.slidesPerView - 1) * S) / i.slidesPerView, i.roundLengths && (y = Math.floor(y)), c[v] && (c[v].style[t("width")] = `${y}px`);
						c[v] && (c[v].swiperSlideSize = y), f.push(y), i.centeredSlides ? (b = b + y / 2 + C / 2 + S, 0 === C && 0 !== v && (b = b - r / 2 - S), 0 === v && (b = b - r / 2 - S), Math.abs(b) < .001 && (b = 0), i.roundLengths && (b = Math.floor(b)), x % i.slidesPerGroup == 0 && u.push(b), h.push(b)) : (i.roundLengths && (b = Math.floor(b)), (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && u.push(b), h.push(b), b = b + y + S), e.virtualSize += y + S, C = y, x += 1
					}
				}
		...
		events: {
			attachEvents: function() {
				...
				e.onTouchStart = M.bind(e), e.onTouchMove = P.bind(e), e.onTouchEnd = L.bind(e), s.cssMode && (e.onScroll = $.bind(e)), e.onClick = O.bind(e), n.touch && !A && (t.addEventListener("touchstart", z), A = !0), I(e, "on")
			},
...
class H {
	constructor() {
		...
		const r = this;
		r.__swiper__ = !0, r.support = C(), r.device = x({
